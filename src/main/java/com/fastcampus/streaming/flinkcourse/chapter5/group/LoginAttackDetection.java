package com.fastcampus.streaming.flinkcourse.chapter5.group;
...
public class LoginAttackDetection {
    public static void main(String[] args) throws Exception {
        final StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();

        DataStream<WebEvent> loginEvents = env.addSource(new WebEventSource());

        Pattern<WebEvent, ?> loginAttackPattern = Pattern.<WebEvent>begin("start")
        ...
        env.execute("Login Attack Detection");
    }
}
